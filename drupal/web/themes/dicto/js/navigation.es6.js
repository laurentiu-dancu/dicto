((Drupal) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape') {
        if (props.dicto.areAnySubNavsOpen()) {
          props.dicto.closeAllSubNav();
        } else {
   ...
   */
  Drupal.behaviors.dictoNavigation = {
