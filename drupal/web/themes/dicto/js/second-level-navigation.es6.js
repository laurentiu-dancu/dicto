((Drupal) => {
  const { isDesktopNav } = Drupal.dicto;
  ...
  Drupal.dicto.toggleSubNav = toggleSubNav;
  ...
  Drupal.dicto.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.dicto.areAnySubNavsOpen = areAnySubNavsOpen;
