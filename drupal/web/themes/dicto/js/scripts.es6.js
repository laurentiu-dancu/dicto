...
((Drupal) => {
  ...
  Drupal.dicto.isDesktopNav = isDesktopNav;
  ...
  document.addEventListener('keyup', (e) => {
    if (e.keyCode === 27) {
      ...
      if (
        'toggleSearchVisibility' in Drupal.dicto &&
        'searchIsVisible' in Drupal.dicto &&
        Drupal.dicto.searchIsVisible()
      ) {
        Drupal.dicto.toggleSearchVisibility(false);
      }
      // Close the wide nav.
      else {
        hideWideNav();
