...
(function (Drupal) {
  ...
  function init(props) {
    ...
    props.navWrapper.addEventListener('keydown', function (e) {
      if (e.key === 'Tab') {
        if (e.shiftKey) {
          if (document.activeElement === props.firstFocusableEl && !props.dicto.isDesktopNav()) {
            props.navButton.focus();
            e.preventDefault();
          }
        } else if (document.activeElement === props.lastFocusableEl && !props.dicto.isDesktopNav()) {
          props.navButton.focus();
          e.preventDefault();
        }
      }
