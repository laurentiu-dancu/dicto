 ...
 *
 * @Block(
 *   id = "dicto_views_search_block",
 *   admin_label = @Translation("Search Block"),
 *   category = @Translation("Dicto"),
 * )
 */
class DictoViewsSearchBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    return $this->formBuilder->getForm(DictoViewsSearchForm::class);
  }
